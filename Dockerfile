...
RUN ln -snf /usr/share/zoneinfo/$TZ /etc/localtime && echo $TZ > /etc/timezone &&\
    ...
    apt install -y  gcc clang cmake make automake autogen patch cpio \
                    gzip bzip2 vim wget git sed tar pip python\
                    xz-utils uuid-dev llvm-dev lzma-dev libxml2-dev libssl-dev libbz2-dev libtool \
